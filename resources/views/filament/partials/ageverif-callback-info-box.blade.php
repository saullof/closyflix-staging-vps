    ...
    <div class="flex gap-3 pr-4">
        ...
        <div class="d-flex v-align-center mb-1">
            ...
            <p class="font-semibold text-yellow-800 dark:text-yellow-300 ml-1 mb-0">
                AgeVerif OAuth requires a Callback URL.
            </p>
        </div>

        <div class="space-y-2">
            <p class="text-sm mb-1">
                Add the following Redirect URI in your AgeVerif Webmaster dashboard:
            </p>

            <ul class="list-disc list-inside text-sm mb-0">
                <li>
                    <code>{{ route('age-check.callback') }}</code>
                </li>
            </ul>

            <p class="text-sm mt-2 mb-0">
                Make sure this matches your current environment domain.
            </p>
        </div>
    </div>
