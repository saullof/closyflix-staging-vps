...
/* global  mswpScanPage, showDialog, hideDialog, initTooltips, bindNoLongPressEvents, TextareaHighlighter  */
...
var Post = {
    ...
    reactTo: function (type,id) {
        ...
        if(didReact){
            ...
            reactElement.html(`<ion-icon name="heart" class=" text-primary icon-medium"></ion-icon>`);
        }
        $.ajax({
            type: 'POST',
            data: {
